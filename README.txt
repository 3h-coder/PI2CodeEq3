...
Language: Python 3.9
Recommendations: We highly recommend that you use a python version of 3.9+ as older versions may not be
compatible with the project. We also recommend that you use your own twitter API keys, however note that this
project only supports the free twitter API. Please make sure you do a "pip install -r requirements.txt" 
